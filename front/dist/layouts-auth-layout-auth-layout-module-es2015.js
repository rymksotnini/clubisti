...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvbG9naW4vbG9naW4uY29tcG9uZW50LnNjc3MifQ== */");
    ...
    login(form) {
        ...
        if (!this.authenticationService.isLogged()) {
            ...
            this.authenticationService.login(this.user).subscribe((result) => {
                ...
                const currentUser = new _models_user__WEBPACK_IMPORTED_MODULE_3__["User"]();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvcmVnaXN0ZXIvcmVnaXN0ZXIuY29tcG9uZW50LnNjc3MifQ== */");
...
let RegisterComponent = class RegisterComponent {
    ...
    registerFacebook() {
        console.log("helloo");
        this.authenticationService.facebookLogin().subscribe((response) => {
    ...
    register(form) {
        ...
        if (!this.authenticationService.isLogged()) {
            ...
            this.authenticationService.signup(this.user).subscribe((result) => {
                ...
                console.log('body', result.body);
                const currentUser = new src_app_models_user__WEBPACK_IMPORTED_MODULE_4__["User"]();
                Object.assign(currentUser, result.body.user);
                console.log('user: ' + currentUser);
                console.log('token: ' + result.body.token);
                this.authenticationService.setCurrentUser(currentUser);
